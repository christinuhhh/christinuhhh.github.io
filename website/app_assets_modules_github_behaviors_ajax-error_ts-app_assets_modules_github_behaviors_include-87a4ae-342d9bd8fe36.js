"use strict";(globalThis.webpackChunk=globalThis.webpackChunk||[]).push([["app_assets_modules_github_behaviors_ajax-error_ts-app_assets_modules_github_behaviors_include-87a4ae","ui_packages_soft-navigate_soft-navigate_ts"],{86072:(e,t,r)=>{r.d(t,{a:()=>o,n:()=>i});var n=r(97797);function i(){let e=document.getElementById("ajax-error-message");e&&(e.hidden=!1)}function o(){let e=document.getElementById("ajax-error-message");e&&(e.hidden=!0)}(0,n.on)("deprecatedAjaxError","[data-remote]",function(e){let{error:t,text:r}=e.detail;e.currentTarget===e.target&&"abort"!==t&&"canceled"!==t&&(/<html/.test(r)?(i(),e.stopImmediatePropagation()):setTimeout(function(){e.defaultPrevented||i()},0))}),(0,n.on)("deprecatedAjaxSend","[data-remote]",function(){o()}),(0,n.on)("click",".js-ajax-error-dismiss",function(){o()})},31981:(e,t,r)=>{r.d(t,{A:()=>s,L:()=>l});var n=r(17688),i=r(21403),o=r(97797),a=r(8111);let d=new WeakMap;function s(e){let t=e.closest(".js-render-needs-enrichment");t&&(t.classList.remove("render-error"),d.get(t)?.setLoading(!1))}function l(e,t){let r=e.closest(".js-render-needs-enrichment");return!!r&&(r.classList.add("render-error"),d.get(r)?.setError(!0,t))}function c(e,t,r){let i=r.identifier??"",o=new URL(e,window.location.origin);for(let[e,r]of Object.entries(t))o.searchParams.append(e,`${r}`);return o.hash=i,(0,n.qy)`
    <div
  ...
  `}(0,i.lB)(".js-render-needs-enrichment",{constructor:HTMLElement,initialize:function(e){let t={color_mode:(0,a.PT)()},r=e.getAttribute("data-type"),i=e.getAttribute("data-src"),o=e.getAttribute("data-identity"),s=e.getElementsByClassName("js-render-enrichment-target")[0],l=e.getElementsByClassName("js-render-enrichment-loader")[0],u=s.closest("details"),m=document.createElement("div");m.classList.add("js-render-enrichment-fallback"),e.appendChild(m);let f=s.firstElementChild;m.appendChild(f);let h={setLoading(e){l.hidden=!e},setError:(e,t)=>(h.setLoading(!1),!1!==e&&(f.classList.toggle("render-plaintext-hidden",!e),!!t&&((0,n.XX)([t,f],m),!0)))};d.set(e,h);let p=s.getAttribute("data-plain"),v=s.getAttribute("data-json");if(null==v||null==p)throw h.setError(!0,(0,n.qy)`<p class="flash flash-error">Unable to render rich display</p>`),Error(`Expected to see input data for type: ${r}`);let g=c(i,t,{type:r,identifier:o,contentJson:v}),b=c(i,t,{type:r,identifier:`${o}-fullscreen`,contentJson:v}),y=function(e,t,r){let i=(0,n.qy)`<clipboard-copy
